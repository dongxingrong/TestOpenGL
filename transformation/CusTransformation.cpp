...
//    std::cout << "vec " << vec.x << " " << vec.y << " " << vec.z << " " << vec.w << std::endl;
    ...
    Shader ourShader("../transformation/trans_shader.glsl", "../transformation/trans_frame.glsl"); // you can name your shader files however you like
...
void Transformation::show_practice_two(GLFWwindow *window) {

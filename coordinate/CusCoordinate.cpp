...
void Coordinate::show_practice_one(GLFWwindow *window) {
    ...
    Shader ourShader("../coordinate/coordinate_shader.glsl", "../transformation/trans_frame.glsl"); // you can name your shader files however you like
